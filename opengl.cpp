...
void InitGL()
{
    ...
    GetProcGL(glGenQueries, "glGenQueries");
    GetProcGL(glBeginQuery, "glBeginQuery");
    GetProcGL(glEndQuery, "glEndQuery");
    GetProcGL(glGetQueryObjectiv, "glGetQueryObjectiv");
    GetProcGL(glGetQueryObjectuiv, "glGetQueryObjectuiv");
