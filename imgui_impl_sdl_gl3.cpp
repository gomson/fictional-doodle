...
static int          g_AttribLocationTex = 0, g_UniformLocationSize = 0;
...
void ImGui_ImplSdlGL3_RenderDrawLists(ImDrawData* draw_data)
{
    ...
    glUniform2f(g_UniformLocationSize, io.DisplaySize.x / io.DisplayFramebufferScale.x, io.DisplaySize.y / io.DisplayFramebufferScale.y);
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        for (const ImDrawCmd* pcmd = cmd_list->CmdBuffer.begin(); pcmd != cmd_list->CmdBuffer.end(); pcmd++)
        {
            ...
            else
            {
                ...
                glScissor(
                    (int)pcmd->ClipRect.x * (int)io.DisplayFramebufferScale.x,
                    (int)(io.DisplaySize.y - pcmd->ClipRect.w * (int)io.DisplayFramebufferScale.y),
                    (int)(pcmd->ClipRect.z - pcmd->ClipRect.x) * (int)io.DisplayFramebufferScale.x,
                    (int)(pcmd->ClipRect.w - pcmd->ClipRect.y) * (int)io.DisplayFramebufferScale.y);
...
bool ImGui_ImplSdlGL3_CreateDeviceObjects()
{
    ...
    g_UniformLocationSize = glGetUniformLocation(g_ShaderHandle, "Size");
