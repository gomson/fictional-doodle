...
PROCGL(PFNGLGETFLOATVPROC, glGetFloatv);
...
PROCGL(PFNGLDEPTHFUNCPROC, glDepthFunc);
PROCGL(PFNGLDEPTHMASKPROC, glDepthMask);
...
PROCGL(PFNGLBLENDFUNCSEPARATEPROC, glBlendFuncSeparate);
PROCGL(PFNGLPOLYGONOFFSETPROC, glPolygonOffset);
...
PROCGL(PFNGLMAPBUFFERPROC, glMapBuffer);
PROCGL(PFNGLUNMAPBUFFERPROC, glUnmapBuffer);
...
PROCGL(PFNGLTEXPARAMETERFPROC, glTexParameterf);
PROCGL(PFNGLTEXPARAMETERIPROC, glTexParameteri);
PROCGL(PFNGLTEXPARAMETERIVPROC, glTexParameteriv);
PROCGL(PFNGLTEXPARAMETERFVPROC, glTexParameterfv);
...
PROCGL(PFNGLFINISHPROC, glFinish);
PROCGL(PFNGLGENQUERIESPROC, glGenQueries);
PROCGL(PFNGLBEGINQUERYPROC, glBeginQuery);
PROCGL(PFNGLENDQUERYPROC, glEndQuery);
PROCGL(PFNGLGETQUERYOBJECTIVPROC, glGetQueryObjectiv);
PROCGL(PFNGLGETQUERYOBJECTUIVPROC, glGetQueryObjectuiv);
